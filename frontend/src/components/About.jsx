...
const products = [
    {
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTb5NqpoSAzc96_9_Src1znYklNU1DxPLp28X0mdN7ZJjorjNJNFlgKbyk&s=10",
      ...
      {
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmrCGWbuBbxsME-5R8gcTYfCq3LwHzptqQLMrvbWPk5b5aW8IEFcmkvLE&s=10",
      ...
      {
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLozmqVS9J5LLbQy8JHR6CM_fF4LUPG1_34scsd637Dx9-tWwReN4qeIg&s=10",
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
           ...
           <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                ...
                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTREKDePilvXFG4rgnV5CDjXRvcbox4QGRnxetaBgjfhjXWlletCpFooniN&s=10"
                        alt="About Us"
