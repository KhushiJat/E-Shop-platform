...
import { formatPrice } from "../../utils/formatPrice"; // Import your formatPrice helper

function ProductViewModal({open, setOpen, product, isAvailable}) {
  
  if (!product) return null; // Safety check if product is empty string initially
